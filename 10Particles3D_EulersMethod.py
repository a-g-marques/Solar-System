...
for i in range(calculations):   # updating the Particles values
    ...
    Sun.updateEulersMethod(deltaT)
    Mercury.updateEulersMethod(deltaT)
    Venus.updateEulersMethod(deltaT)
    Earth.updateEulersMethod(deltaT)
    Moon.updateEulersMethod(deltaT)
    Mars.updateEulersMethod(deltaT)
    Saturn.updateEulersMethod(deltaT)
    Jupiter.updateEulersMethod(deltaT)
    Uranus.updateEulersMethod(deltaT)
    Neptune.updateEulersMethod(deltaT)
    if i == (calculations-1):
